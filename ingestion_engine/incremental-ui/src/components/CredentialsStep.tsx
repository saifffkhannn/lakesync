    ...
    <div className="animate-fadeIn">
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">Configure your source, cloud, and target environments.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
        {([
          ...
          const hasConfig = currentPlatform && savedProfiles[cat]?.[currentPlatform] && Object.keys(savedProfiles[cat][currentPlatform]).length > 0;
                    ...
                    <div className="py-3 flex flex-col items-center text-center justify-center animate-fadeIn border-t border-slate-50 mt-2">
                      <div className="space-y-2">
                        <div className="flex items-center justify-center gap-3">
                          ...
                          {/* Plus button to add another platform */}
      ...
      {/* Modal configuration forms overlay */}
      {(['source', 'cloud', 'target'] as const).filter(cat => cat !== 'cloud' || selection.loadType !== 'ABAP').map(cat => {
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500 font-medium max-w-lg">
              Select how data should be ingested from your source database. Full load pulls all data as a snapshot, while Incremental load only pulls new updates.
            </p>
          </div>
          <div className="flex flex-wrap gap-3 shrink-0">
            {([
              ...
              <button
                ...
                className={`flex flex-col text-left p-4 rounded-2xl border-2 transition-all active:scale-95 w-44 ${selection.loadType === strategy.type
