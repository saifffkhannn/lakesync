...
from src.pipeline_state_manager import append_log, update_table_status
...
class PipelineLogger:
    ...
    def update_step_status(self, log, step, status):
        try:
            ...
            if step in step_map:
                ...
                table_name = f"{log.get('source_schema', 'unknown')}.{log.get('source_table', 'unknown')}"
    ...
    def save_logs(self):
        try:
            ...
            csv_path = os.path.join(self.log_dir, f"migration_report_{timestamp_str}.csv")
